...
#ifndef PROG_GAME_GOAL_H
#define PROG_GAME_GOAL_H
#include "../Define.h"
#include "../Object.h"
#include "../Animator.h"
#include <functional>
...
public:
    ...
    Goal(P p) : Object() {
        type = GOAL;
        collisions.getCollisions()->push(Collision(Collision::SQUARE, (P) {p.x, p.y}, (P) {p.x + 1, p.y + 1}, Collision::GOAL));
        this->p = p;
    }
    ...
    void draw(function<P(P)> fp, float scale) override{
        Image rc = RCM::GetImage("../images/objects/goal.png");
        //cout << scale << endl;
        P bufP = (fp((P) {
            .x = p.x  ,
            .y = p.y
